...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Lions.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Detroit Lions";
const SOURCE_TEAM_SLUG = "detroit-lions";
const SOURCE_TEAM_SHORT = "Lions";
...
function main() {
  ...
  console.log(`Incoming Lions trades: ${incomingTrades.length}`);
