...
const previewPath = "reports/quality/nfl-bottom-batch-009-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-009-remaining-14-dump.txt";
...
let out = "Bottom Batch 009 remaining non-clean record dump\n\n";
