...
const previewPath = "reports/quality/nfl-bottom-batch-008-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-008-remaining-12-dump.txt";
...
let out = "Bottom Batch 008 remaining non-clean record dump\n\n";
