...
const previewPath = "reports/quality/nfl-bottom-batch-004-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-004-remaining-13-dump.txt";
...
let out = "Bottom Batch 004 remaining non-clean record dump\n\n";
