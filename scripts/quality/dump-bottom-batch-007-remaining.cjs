...
const previewPath = "reports/quality/nfl-bottom-batch-007-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-007-remaining-22-dump.txt";
...
let out = "Bottom Batch 007 remaining non-clean record dump\n\n";
