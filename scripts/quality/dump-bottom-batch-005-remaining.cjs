...
const previewPath = "reports/quality/nfl-bottom-batch-005-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-005-remaining-16-dump.txt";
...
let out = "Bottom Batch 005 remaining non-clean record dump\n\n";
