...
const previewPath = "reports/quality/nfl-bottom-batch-003-repair-preview-v1.json";
const dataPath = "src/data/nfl/trades.json";
const outPath = "reports/quality/nfl-bottom-batch-003-remaining-13-dump.txt";
...
let out = "Bottom Batch 003 remaining non-clean record dump\n\n";
