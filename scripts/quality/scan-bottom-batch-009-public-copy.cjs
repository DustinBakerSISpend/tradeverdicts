...
function hasBackendLanguage(text) {
  return /publishStatus|qaNotes|provisional|GSC|manually indexed|indexing|hold-review|public import|Status: Ready|Calculated|Verification pending|Retained for TradeVerdicts|AI regrade|Final QA|Pass -|second-pass|import audit|Copilot|VSC import|public-data QA|Batch \d+/i.test(text || "");
}
...
const outPath = "reports/quality/nfl-bottom-batch-009-public-copy-sanity-scan.txt";

let out = "NFL Bottom Batch 009 Public Copy Sanity Scan\n\n";
