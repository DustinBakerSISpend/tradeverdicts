...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Bills.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Buffalo Bills";
const SOURCE_TEAM_SLUG = "buffalo-bills";

const SOURCE_RECEIVED_COL = "Bills Received";
const SOURCE_SENT_COL = "Bills Sent";
const SOURCE_GRADE_COL = "Bills Grade";
const SOURCE_SUMMARY_COL = "Bills Outcome Synopsis";
...
function main() {
  ...
  console.log(`Incoming Bills trades: ${incomingTrades.length}`);
