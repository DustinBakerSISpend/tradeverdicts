...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Dolphins.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Miami Dolphins";
const SOURCE_TEAM_SLUG = "miami-dolphins";

const SOURCE_RECEIVED_COL = "Dolphins Received";
const SOURCE_SENT_COL = "Dolphins Sent";
const SOURCE_GRADE_COL = "Dolphins Grade";
const SOURCE_SUMMARY_COL = "Dolphins Outcome Synopsis";
...
function main() {
  ...
  console.log(`Incoming Dolphins trades: ${incomingTrades.length}`);
