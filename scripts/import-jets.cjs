...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Jets.xlsx");
...
const SOURCE_TEAM_FALLBACK = "New York Jets";
const SOURCE_TEAM_SLUG = "new-york-jets";
const SOURCE_TEAM_SHORT = "Jets";
...
function main() {
  ...
  console.log(`Incoming Jets trades: ${incomingTrades.length}`);
