...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Browns.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Cleveland Browns";
const SOURCE_TEAM_SLUG = "cleveland-browns";
const SOURCE_TEAM_SHORT = "Browns";
...
function main() {
  ...
  console.log(`Incoming Browns trades: ${incomingTrades.length}`);
