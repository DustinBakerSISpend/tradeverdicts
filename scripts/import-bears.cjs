...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Bears.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Chicago Bears";
const SOURCE_TEAM_SLUG = "chicago-bears";
const SOURCE_TEAM_SHORT = "Bears";
...
function main() {
  ...
  console.log(`Incoming Bears trades: ${incomingTrades.length}`);
