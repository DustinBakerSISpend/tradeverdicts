...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Saints.xlsx");
...
const SOURCE_TEAM_FALLBACK = "New Orleans Saints";
const SOURCE_TEAM_SLUG = "new-orleans-saints";

const SOURCE_RECEIVED_COL = "Saints Received";
const SOURCE_SENT_COL = "Saints Sent";
const SOURCE_GRADE_COL = "Saints Grade";
const SOURCE_SUMMARY_COL = "Saints Outcome Synopsis";
...
function main() {
  ...
  console.log(`Incoming Saints trades: ${incomingTrades.length}`);
