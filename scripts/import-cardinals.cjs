...
const INPUT_FILE = path.join(__dirname, "..", "data-imports", "TradeVerdicts_Cardinals.xlsx");
...
const SOURCE_TEAM_FALLBACK = "Arizona Cardinals";
const SOURCE_TEAM_SLUG = "arizona-cardinals";

const SOURCE_RECEIVED_COL = "Cardinals Received";
const SOURCE_SENT_COL = "Cardinals Sent";
const SOURCE_GRADE_COL = "Cardinals Grade";
const SOURCE_SUMMARY_COL = "Cardinals Outcome Synopsis";
...
function main() {
  ...
  console.log(`Incoming Cardinals trades: ${incomingTrades.length}`);
